...
const en = {
  ...
  "channel.deleteConfirm": "Delete this channel and all its messages?",
  "channel.newName": "New channel name",
  ...
  "vset.camera": "Camera",
  "vset.bgNone": "No background effect",
  "vset.bgBlur": "Blur background",
  "vset.bgHelp": "Keeps you sharp and blurs everything behind you. The model downloads once from your server.",
  ...
  "chat.jumpToBottom": "Jump to newest",
  "chat.seen": "Seen",
  "chat.today": "Today",
  ...
  "forward.search": "Forward to…",
  "forward.done": "Forwarded",
  "forward.none": "No channels available",
  "call.incoming": "Incoming call…",
  "call.accept": "Accept",
  "call.decline": "Decline",
  "voice.soundboard": "Soundboard",
  "voice.mutedHint": "Your mic is off — click to unmute",
  "voice.localMute": "Mute for me",
  "voice.localUnmute": "Unmute for me",
  "sticker.title": "Stickers",
  "sticker.namePlaceholder": "Sticker name",
  "sticker.needName": "Enter a sticker name first",
  "sticker.none": "No stickers yet — upload some via the server menu.",
  "stats.title": "Server stats",
  "stats.messages": "Messages",
  "stats.members": "Members",
  "stats.channels": "Channels",
  "stats.perDay": "Messages per day (14 days)",
  "stats.topAuthors": "Most active (30 days)",
  "stats.noData": "No messages in the last 30 days.",
  "stats.hint": "Counted across all text channels of this server.",
  "thread.title": "Thread",
  "thread.start": "Start thread",
  "thread.open": "Open thread",
  "thread.replies": "{n} replies",
  "thread.placeholder": "Reply in thread…",
  "thread.empty": "No replies yet — start the discussion.",
  "thread.send": "Send",
  "msg.addReaction": "Add reaction",
  "msg.copyText": "Copy text",
  "msg.copyLink": "Copy link",
  "msg.bookmark": "Bookmark",
  "msg.removeBookmark": "Remove bookmark",
  "msg.pinned": "Pinned",
  "msg.new": "New",
  "msg.jumpToMessage": "Jump to message",
  "msg.viewProfile": "View profile",
  "msg.dropFiles": "Drop files to upload (no size limit)",
  ...
  "search.hint": "Type 2+ characters. Filters: from:name · has:link · has:file",
  ...
  "settings.effectsDesc": "Animations and transitions. \"Off\" disables everything (fastest), \"Full\" adds message slide-ins, badge pulses and smooth hovers.",
  "settings.fx.off": "Off",
  "settings.fx.reduced": "Reduced",
  "settings.fx.full": "Full",
  "settings.gameActivity": "Game activity",
  "settings.gameActivityDesc": "Show the game you're playing as your status (\"🎮 Играет в …\"). Never overrides a status you set yourself.",
  "settings.gameActivityOn": "Enabled",
  "settings.gameActivityOff": "Disabled",
...
const ru: Record<keyof typeof en, string> = {
  ...
  "channel.deleteConfirm": "Удалить этот канал и все его сообщения?",
  "channel.newName": "Новое название канала",
  ...
  "vset.camera": "Камера",
  "vset.bgNone": "Без эффекта фона",
  "vset.bgBlur": "Размытие фона",
  "vset.bgHelp": "Вы остаётесь чёткими, а всё позади размывается. Модель скачивается один раз с вашего сервера.",
  ...
  "chat.jumpToBottom": "Вниз к новым",
  "chat.seen": "Прочитано",
  "chat.today": "Сегодня",
  "chat.yesterday": "Вчера",
  "chat.markAllRead": "Отметить всё прочитанным",
  ...
  "forward.search": "Куда переслать…",
  "forward.done": "Переслано",
  "forward.none": "Нет доступных каналов",
  "call.incoming": "Входящий звонок…",
  "call.accept": "Принять",
  "call.decline": "Отклонить",
  "voice.soundboard": "Саундборд",
  "voice.mutedHint": "Микрофон выключен — нажмите, чтобы включить",
  "voice.localMute": "Заглушить для меня",
  "voice.localUnmute": "Вернуть звук",
  "sticker.title": "Стикеры",
  "sticker.namePlaceholder": "Название стикера",
  "sticker.needName": "Сначала введите название стикера",
  "sticker.none": "Стикеров пока нет — загрузите через меню сервера.",
  "stats.title": "Статистика сервера",
  "stats.messages": "Сообщений",
  "stats.members": "Участников",
  "stats.channels": "Каналов",
  "stats.perDay": "Сообщения по дням (14 дней)",
  "stats.topAuthors": "Самые активные (30 дней)",
  "stats.noData": "За последние 30 дней сообщений нет.",
  "stats.hint": "Считается по всем текстовым каналам сервера.",
  "thread.title": "Ветка",
  "thread.start": "Создать ветку",
  "thread.open": "Открыть ветку",
  "thread.replies": "В ветке: {n}",
  "thread.placeholder": "Ответить в ветке…",
  "thread.empty": "Пока нет ответов — начните обсуждение.",
  "thread.send": "Отправить",
  "msg.addReaction": "Добавить реакцию",
  "msg.copyText": "Копировать текст",
  "msg.copyLink": "Копировать ссылку",
  "msg.bookmark": "В закладки",
  "msg.removeBookmark": "Убрать из закладок",
  "msg.pinned": "Закреплено",
  "msg.new": "Новое",
  "msg.jumpToMessage": "Перейти к сообщению",
  "msg.viewProfile": "Профиль",
  "msg.dropFiles": "Отпустите файлы для загрузки (без ограничений)",
  ...
  "search.hint": "Введите 2+ символа. Фильтры: from:имя · has:link · has:file",
  ...
  "settings.removeAvatar": "Убрать аватар",
  "settings.uploadBanner": "Загрузить баннер",
  "settings.removeBanner": "Убрать баннер",
  "crop.title": "Расположите фото",
  "crop.zoom": "Масштаб",
  "crop.hint": "Двигайте пальцем · ползунок — масштаб",
  ...
  "settings.effects": "Визуальные эффекты",
  "settings.effectsDesc": "Анимации и переходы. «Выкл» отключает всё (максимальная скорость), «Максимум» добавляет появление сообщений, пульс бейджей и плавные наведения.",
  "settings.fx.off": "Выкл",
  "settings.fx.reduced": "Умеренно",
  "settings.fx.full": "Максимум",
  "settings.gameActivity": "Игровая активность",
  "settings.gameActivityDesc": "Показывать, во что вы играете, в статусе («🎮 Играет в …»). Никогда не заменяет статус, который вы написали сами.",
  "settings.gameActivityOn": "Включено",
  "settings.gameActivityOff": "Выключено",
